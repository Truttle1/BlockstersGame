...
void Ground::render()
{
	...
	if(biome == GRASS)
	{
		DrawTexture(*grassImage,x,y,WHITE);
	}
}
Ground::~Ground() {
}
...
void Ground::setupLandGraphics(Texture2D* dirt, Texture2D* beach,Texture2D* tundra,Texture2D* desert,Texture2D* mountain,Texture2D* snow,Texture2D* grass)
{
